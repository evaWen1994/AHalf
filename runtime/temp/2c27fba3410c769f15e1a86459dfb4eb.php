<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:87:"E:\GratuateProject\phpStudy\WWW\AHalf\public/../application/index\view\login\login.html";i:1487575048;s:87:"E:\GratuateProject\phpStudy\WWW\AHalf\public/../application/index\view\public\base.html";i:1487559357;s:89:"E:\GratuateProject\phpStudy\WWW\AHalf\public/../application/index\view\Public\header.html";i:1487571066;s:89:"E:\GratuateProject\phpStudy\WWW\AHalf\public/../application/index\view\Public\footer.html";i:1487571593;}*/ ?>
<html>
<head>
    <meta charset="utf-8">
        ...
        <form method="post" action="">
            <div  style="font-size:18px;">
                ...
                <div style="color:#DFDFDF;height:auto;">
                    <input type="text" name="username" id="username" maxlength="32" placeholder="username" style="background-color: #b8c5b2;"/>                   </div>

                <div style="color:#DFDFDF;height:auto;">
                    <!--<input type="password" placeholder="请输入密码" name="password" id="password" onblur="checkPsd(this)"/>-->
                    <input type="password" placeholder="password" name="password" id="password" style="background-color:#b8c5b2"/>
                </div>

                <input type="submit" style="background-color:#90b575;" value="登录"  style="background-color: #98b1d3"/>
